...
You can obtain a key from [OpenRouter](https://openrouter.ai/).
...
The dispatcher in [`mcp_waifu_chat/ai.py`](mcp_waifu_chat/ai.py:1) selects the provider and generates responses.
